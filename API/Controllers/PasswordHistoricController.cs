...
namespace API.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class PasswordHistoricController : ControllerBase
    {
        private readonly IPlantService _plantService;

        public PasswordHistoricController(IPlantService plantService)
        {
            _plantService = plantService;
        }

        // GET: /password_hitorics
        [HttpGet("password_hitorics")]
