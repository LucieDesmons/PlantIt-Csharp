...
namespace API.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class PictureReferenceController : ControllerBase
    {
        private readonly IPlantService _plantService;

        public PictureReferenceController(IPlantService plantService)
        {
            _plantService = plantService;
        }

        // GET: /picture_references
        [HttpGet("picture_references")]
